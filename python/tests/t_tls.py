...
""")
    ...
    def queries(self):
        ...
        yield Query(self.url(self.name + "/"), insecure=True, minTLSv="v1.3", error=["tls: alert(116)", "tls: certificate required", "Get https://clientcertificateauthentication/ClientCertificateAuthentication/: http: server gave HTTP response to HTTPS client"])
